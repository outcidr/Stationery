...
namespace Stationery.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(StationeryContext context)
        {
            _context = context;
        }
        ...
        {
            var stationeryContext = _context.Product.Include(p => p.Category);
            return View(await stationeryContext.ToListAsync());
        }
